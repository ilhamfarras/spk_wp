...
<head>
    ...
    <!-- Fonts -->
    <link href="{{ asset('vendor/fontawesome-free/css/all.mixn.css') }}" rel="stylesheet">
    <link
...
<body id="page-top" style="background-color: #131842;">

    <!-- Page Wrapper -->
    <div id="wrapper">
        <!-- Sidebar -->x
        <ul style="background-color: #131842;" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">pemilihan pemain terbaik VCT Pacific</div>
            </a>
